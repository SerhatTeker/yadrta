...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", default=["example.com"])
...
SECURE_HSTS_INCLUDE_SUBDOMAINS = os.get(
    "DJANGO_SECURE_HSTS_INCLUDE_SUBDOMAINS", default=True
)
# https://docs.djangoproject.com/en/dev/ref/settings/#secure-hsts-preload
SECURE_HSTS_PRELOAD = os.get("DJANGO_SECURE_HSTS_PRELOAD", default=True)
