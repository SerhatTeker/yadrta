...
from .permissions import GetOnlyOwnerObjectQuerysetMixin
...
class BaseModelViewSetWithTracking(
    GetOnlyOwnerObjectQuerysetMixin, LoggingMixin, viewsets.ModelViewSet
):
    pass
